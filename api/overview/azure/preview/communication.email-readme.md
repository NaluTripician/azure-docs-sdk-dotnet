...
---
# Azure Communication Email client library for .NET - version 1.1.0-beta.3 
...
[source]: https://github.com/Azure/azure-sdk-for-net/tree/Azure.Communication.Email_1.1.0-beta.3/sdk/communication/Azure.Communication.Email/src
